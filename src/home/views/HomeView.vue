    ...
    <div class="container mx-auto flex flex-wrap py-6 overflow-auto">
      ...
      <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        ...
        <template v-for="(post, index) in homeStore.listOfPosts" :key="index">
          <article class="flex flex-col shadow my-4">
            <a class="relative hover:opacity-75">
              ...
              <NImage v-if="post?.miniature" :src="'https://res.cloudinary.com/duobjlhl9/' + post?.miniature"
                alt="Blog Cover" class="object-cover" />
            </a>
        ...
        <div v-if="numPages" class="flex items-center py-8 gap-2">
          <a v-for="(number, index) in numPages" :key="index" @click="changePage(number)" :class="{
